const Footer = () => {
  const columns = [
    ...
    },
    {
      title: "Channels",
      links: [
        { label: "Live TV", href: "/channels/live" },
        { label: "Channel Guide", href: "/channels/guide" },
        { label: "Sports", href: "/channels/sports" },
        { label: "News", href: "/channels/news" },
      ],
    },
    {
      title: "Radio",
      links: [
        { label: "Stream Now", href: "/radio" },
        { label: "Stations", href: "/radio/stations" },
        { label: "Podcasts", href: "/radio/podcasts" },
