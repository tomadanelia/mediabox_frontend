                ...
                <div>
                    <div className="relative mt-10">
                        <div className="absolute inset-0 flex items-center" aria-hidden="true">
                            <div className="w-full border-t dark:border-gray-500 border-gray-200" />
                        </div>
                        <div className="relative flex justify-center text-sm font-medium leading-6">
                            <span className="px-6 bg-white dark:bg-gray-700 dark:text-gray-200 text-gray-900">Or continue with</span>
                        </div>
                    </div>
